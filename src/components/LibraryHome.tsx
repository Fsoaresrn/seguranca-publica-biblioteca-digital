...
const LibraryHome: React.FC<LibraryHomeProps> = ({
  ...
  return <div className="min-h-screen bg-govbr-gray-5">
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-white text-govbr-blue-warm-vivid hover:bg-gray-100 text-lg px-8 py-3" onClick={() => onNavigate && onNavigate('repository')}>
                Explorar Acervo
              </Button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <Input placeholder="Buscar por título, autor, palavras-chave..." className="pl-12 h-14 text-lg rounded-lg border-2 border-gray-200 focus:border-govbr-blue-warm-vivid" />
              <Button className="absolute right-2 top-2 govbr-btn-primary h-10" onClick={() => onNavigate && onNavigate('search')}>
                Buscar
              </Button>
            </div>
          </div>
      ...
      <section className="py-12 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {categories.map(category => <Card key={category.id} className="hover:shadow-lg transition-shadow cursor-pointer group" onClick={() => handleCategoryClick(category.id)}>
      ...
      <section className="py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {featuredWorks.map(work => <Card key={work.id} className="hover:shadow-lg transition-shadow">
                <CardContent className="p-4 lg:p-6">
                  ...
                  <div className="flex gap-2">
                    <Button variant="outline" size="sm" className="flex-1" onClick={() => handleFavorite(work.id)}>
                      <Heart className={`h-4 w-4 mr-1 ${work.isFavorited ? 'fill-red-500 text-red-500' : ''}`} />
                      Favoritar
                    </Button>
                    <Button size="sm" className="govbr-btn-primary flex-1" onClick={() => handleDownload(work.id, work.title)}>
          ...
          <div className="text-center mt-8">
            <Button variant="outline" size="lg" onClick={() => onNavigate && onNavigate('repository')}>
