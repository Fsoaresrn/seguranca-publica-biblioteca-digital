...
const AuthorInfoSection: React.FC<AuthorInfoSectionProps> = ({
  ...
  return <Card className="govbr-card">
      <CardHeader>
      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          field
                ...
                <FormControl>
                  <Input placeholder="Nome completo do autor" className="govbr-input" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>} />
          ...
          field
                ...
                <FormControl>
                  <Input type="email" placeholder="email@instituicao.gov.br" className="govbr-input" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>} />
        </div>
